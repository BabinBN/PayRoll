...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheEmployeesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheEmployeesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheEmployeesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheEmployeesListGenerated.onTable(defaultTableId).iCheckRows();
        // });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheEmployeesListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"emp_code":{"header":"emp_code"},"first_name":{"header":"first_name"},"last_name":{"header":"last_name"},"email":{"header":"email"}});
        });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheEmployeesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheEmployeesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheEmployeesListGenerated.onTable(defaultTableId).iPressRow(0);
