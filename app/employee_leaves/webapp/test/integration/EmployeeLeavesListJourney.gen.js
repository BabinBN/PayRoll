...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("EmployeeLeavesListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheEmployeeLeavesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheEmployeeLeavesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheEmployeeLeavesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheEmployeeLeavesListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheEmployeeLeavesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheEmployeeLeavesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheEmployeeLeavesListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheEmployeeLeavesObjectPageGenerated.iSeeThisPage();
        });
